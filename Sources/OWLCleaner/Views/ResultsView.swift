...
struct ResultsView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog(
            ...
            Text("Permanently deletes the selected caches, logs and temporary files (Large & Old files go to the Trash instead). Everything here is regenerated by its app — but quit apps you're actively using for a clean result.")
        }
    }
